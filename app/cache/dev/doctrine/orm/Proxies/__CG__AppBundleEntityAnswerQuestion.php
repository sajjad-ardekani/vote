 ...
 */
class AnswerQuestion extends \AppBundle\Entity\AnswerQuestion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AnswerQuestion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AnswerQuestion' . "\0" . 'question', '' . "\0" . 'AppBundle\\Entity\\AnswerQuestion' . "\0" . 'text'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnswerQuestion $proxy) {
