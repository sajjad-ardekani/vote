 ...
 */
class Vote extends \AppBundle\Entity\Vote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Vote' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Vote' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Vote' . "\0" . 'answers', '' . "\0" . 'AppBundle\\Entity\\Vote' . "\0" . 'ip', '' . "\0" . 'AppBundle\\Entity\\Vote' . "\0" . 'note', '' . "\0" . 'AppBundle\\Entity\\Vote' . "\0" . 'createAt'];
        }
    ...
    public function setDateValue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateValue', []);
