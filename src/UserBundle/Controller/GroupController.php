...
class GroupController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $getGroup = $em->getRepository('AppBundle:User\Group')->findOneBy(['name' => $group->getName()]);
            if(!$getGroup){
            $event = new FormEvent($form, $request);
            ...
            return $response;
                ...
                $this->addFlash('error', 'Group has been exist');
                $this->redirectToRoute('fos_user_group_new');
            }
        }
