...
class UploadHandler
{
    ...
    public $sizeLimit; // 256MB
    public $inputName;
    public $chunksFolder;
    public $uploadFolder;
    public $chunksCleanupProbability; // Once in 1000 requests on avg
    public $chunksExpireIn; // One week
    protected $uploadName;

    public function __construct()
    {
        $this->allowedExtensions = array("png","jpg", "jpeg", "pdf", "zip", "doc", "xlsx", "xls", "doc", "docx", "tif");
        $this->sizeLimit = 1024 * 1024 * 256; // 256MB
        $this->inputName = 'qqfile';
        $this->chunksFolder = __DIR__ . '/../../../uploader/chunkes';
        $this->uploadFolder = __DIR__ . '/../../../uploader/files';
        $this->chunksCleanupProbability = 0.001; // Once in 1000 requests on avg
        $this->chunksExpireIn = 604800; // One week
    }
...
//            return $_FILES[$this->inputName]['name'];
    ...
    public function combineChunks($uploadDirectory = null)
    {
     ...
     *
     */
    public function handleDelete($uploadDirectory = null, $name = null)
    {
        if ($uploadDirectory === null) {
            $uploadDirectory = $this->uploadFolder;
        }
